...
import {
  ...
  Keyboard, StatusBar, Platform, FlatList, Dimensions, SafeAreaView, Alert
} from 'react-native';
...
// --- 1. SEARCH MODULE (With GPS Button) ---
  ...
  return (
    <View style={styles.searchContainer}>
      <View style={styles.searchBarGlass}>
        ...
        {/* Loading Spinner or Close Button (Right Side) */}
        {isSearching ? (
        ...
        <View style={{ flex: 1 }}>
          {loading ? (
            ...
            <FlatList
              ...
              // FIX: This ensures scrolling works and dismisses keyboard naturally
              keyboardShouldPersistTaps="handled"
              onScrollBeginDrag={() => {
                Keyboard.dismiss();
                setSearchVisible(false); // Close dropdown when user scrolls
              }}
            />
          ) : null}
        </View>
