...
import { scale, getIconProps, STATS_COLORS } from './helpers';
...
const styles = StyleSheet.create({
    ...
    itemContainer: {
        alignItems: 'center',
        width: 60, // Narrow width creates the "Line" effect
        justifyContent: 'flex-end',
        gap: 12,
    },

    // Graph Styling
    graphPointContainer: { alignItems: 'center', gap: 4 },

    // THE ORANGE DOT & TEXT (Graph Line Look)
    dot: {
        width: 8,
        height: 8,
        borderRadius: 4,
    ...
    tempText: { color: '#FFD700', fontSize: scale(16), fontWeight: '700' },
    ...
    windText: { color: '#fff', fontSize: scale(12), fontWeight: '600' },
    unitText: { color: '#888', fontSize: scale(10) }
});
